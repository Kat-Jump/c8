...
These steps show each row of the data is one sample of weight-lifting
...
```
    ...
    ##  Mean   :103.10   Mean   : -87.85   Mean   :17.2        
...
```
    ...
    ## Detection Prevalence   0.2875   0.1882   0.1811   0.1613   0.1819
